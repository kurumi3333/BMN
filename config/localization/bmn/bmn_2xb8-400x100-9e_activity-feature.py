_base_ = [
    '../../_base_/models/bmn_400x100.py',
    '../../_base_/datasets/default_runtime.py'
]
...
val_pipeline = [
    ...
    dict(
        type='PackLocalizationInputs',
        keys=('gt_bbox', ),
        meta_keys=('video_name', 'duration_second', 'duraion_frame',
...
val_dataloader = dict(
    batch_size=1,
    num_workers=8,
    persisent_workers=True,
    sampler=dict(type='DefaultSampler', shufle=False),
    dataset=dict(
        type=dataset_type,
